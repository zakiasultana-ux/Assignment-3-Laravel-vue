    ...
    public function run()
    {
        ...
        $mainCharacters = [
            [
                ...
                'image_url'   => 'https://ui-avatars.com/api/?name=Rachel+Green&size=400&background=6B5BCD&color=fff&bold=true',
            ],
            [
                'name'        => 'Monica Geller',
                ...
                'catchphrase' => 'I KNOW!',
                'image_url'   => 'https://ui-avatars.com/api/?name=Monica+Geller&size=400&background=E8622A&color=fff&bold=true',
            ],
            [
                'name'        => 'Phoebe Buffay',
                ...
                'image_url'   => 'https://ui-avatars.com/api/?name=Phoebe+Buffay&size=400&background=F6C90E&color=1A1A2E&bold=true',
            ],
            [
                'name'        => 'Joey Tribbiani',
                ...
                'image_url'   => 'https://ui-avatars.com/api/?name=Joey+Tribbiani&size=400&background=1A1A2E&color=F6C90E&bold=true',
            ],
            [
                'name'        => 'Chandler Bing',
                ...
                'image_url'   => 'https://ui-avatars.com/api/?name=Chandler+Bing&size=400&background=3A3A5C&color=fff&bold=true',
            ],
            [
                'name'        => 'Ross Geller',
                ...
                'image_url'   => 'https://ui-avatars.com/api/?name=Ross+Geller&size=400&background=9B59B6&color=fff&bold=true',
            ],
        ];
